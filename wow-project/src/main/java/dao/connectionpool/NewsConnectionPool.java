...
public class NewsConnectionPool {
	...
	private NewsConnectionPool() {
		DBNewsResourceManager dbResourceManager = DBNewsResourceManager.getInstance();
		this.driverName = dbResourceManager.getValue(DBNewsParameter.DB_NEWS_DRIVER);
		this.url = dbResourceManager.getValue(DBNewsParameter.DB_NEWS_URL);
		this.user = dbResourceManager.getValue(DBNewsParameter.DB_NEWS_USER);
		this.password = dbResourceManager.getValue(DBNewsParameter.DB_NEWS_PASSWORD);

		try {
			this.poolSize = Integer.parseInt(dbResourceManager.getValue(DBNewsParameter.DB_NEWS_POOLSIZE));
